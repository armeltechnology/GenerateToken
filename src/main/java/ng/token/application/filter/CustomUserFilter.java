package ng.token.application.filter;
...
public class CustomUserFilter extends UsernamePasswordAuthenticationFilter{
	...
	public  CustomUserFilter(AuthenticationManager authenticationManager) {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		return authenticationManager.authenticate(uauthenticationToken);
